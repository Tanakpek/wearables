...
b2 = Booking.create!(user: marius, wearable: w5, start_date: Date.today - 2, end_date: Date.today, status: "confirmed")
b3= Booking.create!(user: marius, wearable: w6, start_date: Date.today - 2, end_date: Date.today, status: "confirmed")
b4 = Booking.create!(user: mantas, wearable: w6, start_date: Date.today - 5, end_date: Date.today, status: "confirmed")
b5= Booking.create!(user: mantas, wearable: w5, start_date: Date.today + 10, end_date: Date.today + 20, status: "unconfirmed")
b6 = Booking.create!(user: tan, wearable: w1, start_date: Date.today + 10, end_date: Date.today + 21, status: "unconfirmed")
b7 = Booking.create!(user: tan, wearable: w2, start_date: Date.today + 6, end_date: Date.today + 8, status: "unconfirmed")
b8 = Booking.create!(user: tan, wearable: w3, start_date: Date.today + 14, end_date: Date.today + 16, status: "confirmed")
b10 = Booking.create!(user: tan, wearable: w4, start_date: Date.today + 30, end_date: Date.today + 50, status: "unconfirmed")

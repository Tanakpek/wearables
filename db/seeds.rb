...
w1 = Wearable.new(user: marius, brand: "rolex", category: "watch", price: 150, description: "My 1st Rolex watch for rent now", title: "Rolex for rent")
w2 = Wearable.new(user: marius, brand: "levis", category: "jacket", price: 44, description: "My levis jacket", title: "New Levis jacket")
w3 = Wearable.new(user: mantas, brand: "patek philippe", category: "watch", price: 250, description: "A real patek philippe for you to rent", title: "patek philippe now")
w4 = Wearable.new(user: mantas, brand: "polo", category: "jacket", price: 50, description: "Polo jacket for rent", title: "Polo polo polo")
w5 = Wearable.new(user: tan, brand: "Audemars", category: "watch", price: 450, description: "Audemars my baby for rent for a cheap price", title: "Audemars here!")
w6 = Wearable.new(user: tan, brand: "primarkt", category: "jacket", price: 10, description: "This is my description for my wearable", title: "Renting primark jacket")

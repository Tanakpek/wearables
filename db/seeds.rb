...
w1 = Wearable.new(size: "M", user: marius, brand: "rolex", category: "watch", price: 150, description: "My 1st Rolex watch for rent now", title: "Rolex for rent")
...
w3 = Wearable.new(size: "M", user: mantas, brand: "patek philippe", category: "watch", price: 250, description: "A real patek philippe for you to rent", title: "patek philippe now")
w4 = Wearable.new(size: "M", user: mantas, brand: "polo", category: "jacket", price: 50, description: "Polo jacket for rent", title: "Polo polo polo")
w5 = Wearable.new(size: "M", user: tan, brand: "Audemars", category: "watch", price: 450, description: "Audemars my baby for rent for a cheap price", title: "Audemars here!")
